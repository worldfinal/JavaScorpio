package com.frc.javascorpio.email;
...
{  
    ...
    {  
        ...
        String mailbody = "<span style=\"font-size: 24px;\">查收附件，有2个附件的</span>&#8203;&nbsp;<span style=\"font-size: 32px;\">1<span style=\"color: rgb(0, 0, 255);\">程序自动邮件，勿回</span></span>";//邮件正文  
        themail.setNeedAuth(true);  
        themail.setSubject("带附件的邮件");//邮件主题  
        themail.setBody(mailbody);//邮件正文  
        themail.setTo("fengrenchang86@vip.qq.com");//收件人地址  
        themail.setFrom("fengrenchang86@163.com");//发件人地址  
        themail.addFileAffix("D:/My Documents/ACM经典代码.doc");// 附件文件路径,例如：C:/222.jpg,*注；"/"的写法； 如果没有可以不写
        themail.addFileAffix("D:/My Documents/网上银行登录界面个人版——安全策略及程序实现.doc");
        themail.setNamePass("fengrenchang86@163.com", "novemBer");//发件人地址和密码 **改为相应邮箱密码  
        themail.sendout();  
    }  
}  